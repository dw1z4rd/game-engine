...
export class AssetManager {
  ...
  private readonly config: Required<AssetConfig>;
      ...
      return new Promise<THREE.Texture>((resolve, reject) => {
        ...
        loader.load(
          ...
          (texture) => {
            ...
            if (options.magFilter !== undefined) texture.magFilter = options.magFilter as THREE.MagnificationTextureFilter;
            ...
            if (options.type !== undefined) texture.type = options.type;
   ...
   * Load text data
   */
  async loadText(id: string, url: string): Promise<string> {
  ...
  getTexture(id: string): THREE.Texture | undefined {
    return this.getAsset<THREE.Texture>(id);
  }
  ...
  private cacheAsset(id: string, type: AssetType, data: any): void {
  ...
  private updateProgress(assetId: string, progress: number): void {
