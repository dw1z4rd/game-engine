...
(function (UIElementType) {
    ...
    UIElementType["INPUT_FIELD"] = "input_field";
...
export class UIElement {
    ...
    setProgress(value) {
        if (this.type === UIElementType.PROGRESS_BAR) {
            const progressBar = this.element.querySelector('div > div');
            if (progressBar) {
...
export class UIManager {
    ...
    update(deltaTime) {
        for (const element of this.elements.values()) {
            if (element.visible && element.onUpdate) {
